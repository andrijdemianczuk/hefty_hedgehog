...
dbutils.widgets.text("catalog", "ademianczuk", "Catalog")
dbutils.widgets.text("db", "council_memos", "Database")
...
#model_path =  "/dbmodels/product/llm"
model_path = "/Users/andrij.demianczuk@databricks.com/dbmodels/docsearch"

# Cache our model to dbfs to avoid loading them everytime
hugging_face_cache = "/dbfs"+model_path+"/cache/hf"
