...
# MAGIC To run this demo, just select the cluster `dbdemos-llm-rag-chatbot-andrij_demianczuk` from the dropdown menu ([open cluster configuration](https://e2-demo-field-eng.cloud.databricks.com/#setting/clusters/1109-042343-5c1y52o2/configuration)). <br />
...
wait_for_index_to_be_ready(vs_index_fullname, vsc)
